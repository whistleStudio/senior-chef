	...
	<view class="page">
		...
		<view class="content">
			...
			<view class="body-text">
				...
				<text class="p">这段时间家里蹲也没太闲着，学点新东西，折腾了几个自娱自乐的小项目，然后就是每天做做饭，可以说是厨艺大涨了！土土也快来了（希望ta能喜欢这个略土的小名），不用担心吃不到家的味道啦，至少妈妈是给予大拇指肯定的。其实开发最初的想法也是妈妈提出来的，体检说是缺少点营养元素，想着能从健康的食材里或多或少补充些，便做了这个智能生成菜谱的小程序。</text>
				<text class="p">至于为什么是小喵，当然是因为家里有只小喵嘛，闲事科科长每次都会在我做饭的时候，在砧板边蜷成一团倾情指导。</text>
				<text class="p">(p.s. 有事请联系小喵~安德这是我的B站账号【工具汪whistle】, 欢迎瞅瞅)</text>
			</view>
		</view>
